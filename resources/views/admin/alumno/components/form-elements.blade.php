...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('ApellidoPaterno'), 'has-success': fields.ApellidoPaterno && fields.ApellidoPaterno.valid }">
    <label for="ApellidoPaterno" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.alumno.columns.ApellidoPaterno') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.ApellidoPaterno" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('ApellidoPaterno'), 'form-control-success': fields.ApellidoPaterno && fields.ApellidoPaterno.valid}" id="ApellidoPaterno" name="ApellidoPaterno" placeholder="{{ trans('admin.alumno.columns.ApellidoPaterno') }}">
