                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.empleado.columns.id') }}</th>
                                        <th is='sortable' :column="'Nombre'">{{ trans('admin.empleado.columns.Nombre') }}</th>
                                        <th is='sortable' :column="'ApellidoPaterno'">{{ trans('admin.empleado.columns.ApellidoPaterno') }}</th>
                                        <th is='sortable' :column="'ApellidoMaterno'">{{ trans('admin.empleado.columns.ApellidoMaterno') }}</th>
                                        <th is='sortable' :column="'Telefono'">{{ trans('admin.empleado.columns.Telefono') }}</th>
                                        <th is='sortable' :column="'Edad'">{{ trans('admin.empleado.columns.Edad') }}</th>
                                        <th is='sortable' :column="'FechaNacimiento'">{{ trans('admin.empleado.columns.FechaNacimiento') }}</th>
                                        <th is='sortable' :column="'LugarNacimiento'">{{ trans('admin.empleado.columns.LugarNacimiento') }}</th>
