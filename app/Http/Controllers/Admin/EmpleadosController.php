...
class EmpleadosController extends Controller
{
    ...
    public function index(IndexEmpleado $request)
    {
        ...
        $data = AdminListing::create(Empleado::class)->processRequestAndGet(
            ...
            ['id', 'Nombre', 'ApellidoPaterno', 'ApellidoMaterno', 'Telefono', 'Edad', 'FechaNacimiento', 'LugarNacimiento'],

            // set columns to searchIn
            ['id', 'Nombre', 'ApellidoPaterno', 'ApellidoMaterno', 'Telefono', 'LugarNacimiento']
        );
