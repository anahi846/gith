...
$factory->define(App\Models\Alumno::class, static function (Faker\Generator $faker) {
    return [
        ...
        'ApellidoPaterno' => $faker->sentence,
        'ApellidoMaterno' => $faker->sentence,
...
$factory->define(App\Models\Empleado::class, static function (Faker\Generator $faker) {
    return [
        ...
        'Edad' => $faker->randomNumber(5),
        'FechaNacimiento' => $faker->date(),
        'LugarNacimiento' => $faker->sentence,
        'created_at' => $faker->dateTime,
        'updated_at' => $faker->dateTime,
...
/** @var  \Illuminate\Database\Eloquent\Factory $factory */
$factory->define(App\Models\Puesto::class, static function (Faker\Generator $faker) {
    return [
        'Nombre' => $faker->sentence,
        'ApellidoPaterno' => $faker->sentence,
        'ApellidoMaterno' => $faker->sentence,
